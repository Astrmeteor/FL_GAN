...
# Loss
def get_batched_loss(args, data_loader, model, loss_func, prior_only=None, loss_triples=True):
    """
    ...
    for images, labels in loop:
        ...
        out = model(images) if prior_only is None else model(images, prior_only)
