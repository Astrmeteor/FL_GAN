...
"""
## Wrapping up the training loop inside `VAETrainer`
"""
...
class VAETrainer(keras.models.Model):
    ...
    def train_step(self, x):
        ...
        return {
            ...
            "vae_loss": self.vq_loss_tracker.result(),
        }
...
class CustomCallback(keras.callbacks.Callback):
    def on_epoch_end(self, epoch, logs=None):
        ...
        checkpoint_path = iwantto_path + f"/{args.dataset}/vae/{'dp' if args.dpsgd else 'normal'}/model"
...
def main():
    ...
    vae_trainer = VAETrainer(data_variance, args.dataset,
    ...
    # Save metrics
    vqvae_metric_save_path = iwantto_path + f"/{args.dataset}/vae/{'dp' if args.dpsgd else 'normal'}/metric"
    ...
    VAE
    """
    reconstruction_path_traditional_flow = iwantto_path + f"/{args.dataset}/vae/{'dp' if args.dpsgd else 'normal'}/Images"
